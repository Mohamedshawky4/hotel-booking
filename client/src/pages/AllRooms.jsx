...
const AllRooms = () => {
    ...
    const roomTypes = ["Single Bed", "Double Bed", "Family Suite", "Luxury Suite", ]
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
       <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>take advantage of our limited-time offers and special packages to book your next stay</p>
            </div>
                ...
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    <img src={room.images[0]} alt={room.hotel.name} title='view room details'
                     ...
                     <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p className='text-gray-800 font-medium text-xl'>${room.pricePerNight}/night</p>
