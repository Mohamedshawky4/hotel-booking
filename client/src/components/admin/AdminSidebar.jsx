...
const AdminSidebar = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            label: t('admin.sidebar.bookings') || 'Bookings'
        },
        {
    ...
    return (
        <div className="w-64 bg-white shadow-lg min-h-screen">
            <div className="p-6">
                <h2 className={`text-xl font-bold text-gray-800 ${isRTL ? 'font-arabic' : ''}`}>
            ...
            <div className="absolute bottom-0 w-64 p-4">
                <button
                    ...
                    className={`w-full flex items-center px-4 py-3 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 ${isRTL ? 'font-arabic' : ''}`}
                >
